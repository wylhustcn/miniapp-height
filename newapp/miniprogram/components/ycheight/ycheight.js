...
Component({
    ...
    methods: {
        show(){
            ...
            const {curHeight,childInfo}=app.globalData
            ...
            const preheight=u.getPreHeight(sex,fheight,mheight)

            console.log( herheight,
                wheight,
                preheight,)
            var  is_high=true
            if(preheight>=wheight){
                is_high=true
            }else{
             is_high=false
            }
                ...
                series: [
                    {
                        ...
                        barWidth: 30,		
                        type: 'bar',
                        data: [ hdata.wheight, hdata.herheight,hdata.preheight], 
